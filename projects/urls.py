...
from .views import (ProjectDeleteAPIView, ProjectGetByIdAPIView,
                    ProjectListCreate, ProjectUpdateAPIView, UserProjectsView, download_file)
...
urlpatterns = [
    ...
    path('projects/<int:user_id>/by_user/', UserProjectsView.as_view(), name='project-list-by-user')
]
